"""
Quick Correlation Analysis - 2020-2021 Modern Market Period
"""
import os
import sqlite3
import pandas as pd
...
print("="*70)
print("FULL CORRELATION ANALYSIS (2020-2021 Modern Market)")
print("="*70)
...
# Focus on 2020-2021 period (mature market, before orbitaal ends)
target_files = []
for f in files:
    parts = f.split("-")
    if len(parts) >= 6:
...
print(f"      2020-2021 overlap: {len(target_files)} days")

# Process ALL overlap days
print("[3/4] Processing ALL 2020-2021 days...")
results = []
